...
public class QueryResultsWindow extends JFrame {
	 ...
	 * Create the frame.
	 */
	public QueryResultsWindow(String queryRes) {
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Modality", "Provision Type", "Location in Section"
			}
		));
	...
	void PrintQueryResult()
	{
		...
		if(queryResult.contains("bindings"))
		{
			...
			while(queryResult.indexOf("Provision") != -1)
			{
				...
				model.addRow(new Object[]{Modality,Provision,subSection});
